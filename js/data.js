const synonymGroups = [
  ...
  { id: "contrast_opposite", label: "Tương phản (So sánh đối lập)", grammarIds: [15, 17, 147, 205], nuances: ["• (으)ㄴ/는 반면에: So sánh 2 mặt đối lập (Trái lại).", "• (으)ㄴ/는 데 반해: Trong khi đó, trái lại.", "• (으)ㄴ/는가 하면: Cùng một chủ thể nhưng có 2 mặt đối lập (Mặt này... mặt kia).", "• 기는 하지만: Thừa nhận vế trước nhưng đưa ra nhận xét đối lập ở vế sau."] },
  ...
  { id: "concession_useless", label: "Nhượng bộ (Dù làm cũng vô ích)", grammarIds: [24, 32, 115, 117, 118], nuances: ["• (나) 마나: Làm cũng vô ích vì biết trước kết quả.", "• 아/어 봐야 / 어/아 봤자: Dù có cố thì kết quả vẫn không đổi.", "• 아/어 봐도: Nhẹ hơn 봐야 một chút.", "• 본다고 해도: Dùng trong văn viết hoặc trang trọng.", " PHÂN BIỆT: Nhóm này luôn mang sắc thái tiêu cực/vô ích. Khác hoàn toàn với '아/어도' (nhượng bộ trung lập)."] },
  {
    id: "choice_any",
    label: "Lựa chọn (Bất kể... hay... / Hoặc)",
    grammarIds: [25],
    nuances: ["• 든지: Lựa chọn không phân biệt. KHÔNG mang tính giả định nhượng bộ lùi bước."]
  },
  ...
  { id: "reason_negative", label: "Nguyên nhân (Tiêu cực / Đổ lỗi)", grammarIds: [12, 53, 54, 55], nuances: ["• 는 바람에: Bất ngờ → Kết quả TIÊU CỰC.", "• 느라고: Tốn thời gian làm vế 1 nên vế 2 TIÊU CỰC.", "• ㄴ/은 탓에: Đổ lỗi, trách móc → Kết quả TIÊU CỰC.", "• 는 통에: Hoàn cảnh ồn ào, hỗn loạn → Kết quả TIÊU CỰC."] },
  {
    id: "reason_extreme",
    label: "Nguyên nhân (Do quá mức)",
    grammarIds: [14],
    nuances: ["• (으)ㄴ 나머지: Tập trung làm một việc gì đó quá mức dẫn đến hậu quả. Khác với 는 바람에 (bị ngoại cảnh tác động bất ngờ)."]
  },
  ...
  { id: "according", label: "Theo như", grammarIds: [36], nuances: ["• 는 대로 (nghĩa 1): Làm y hệt vế trước."] },
  ...
  { id: "obvious_skip", label: "Thừa thãi vì quá hiển nhiên / Không cần làm", grammarIds: [116, 193, 194], nuances: ["• (으)ㄹ 것도 없이: Hành động V thừa thãi vì kết quả đã quá hiển nhiên.", "• 두말할 것도 없이: Đương nhiên tuyệt đối, trạng từ nhấn mạnh không cần nói lại lần hai.", "• 굳이 (~지 않아도 되다): Không cần phải cố sức làm điều đó. Nhấn mạnh sự không cần thiết VỀ MẶT NỖ LỰC."] },];
...
const grammarData = [
  ...
  },
  {
    ...
    ], notes: " CHỈ kết hợp với Tính từ (형용사). KHÔNG dùng với Động từ (Ví dụ: 먹어 보이다 -> SAI). Constraint: Chỉ dùng với Tính từ. Không thay thế bằng 는 모양이다 với Động từ.",
    ownExamples: [
      { sentence: "친구가 기분 좋은 일이 있는지 기분이 <b>좋아 보였다</b>.", translation: "Bạn tôi trông có vẻ vui, chắc là có chuyện gì tốt." }
    ]
  },
  ...
  {
    // THAY ĐỔI: Xóa "(으)려면" khỏi synonymPatterns — hai cấu trúc đối nghịch nhau về đuôi câu.
    // 기 위해서 KHÔNG đi với đuôi mệnh lệnh/rủ rê; (으)려면 BẮT BUỘC đi với đuôi đó.
    id: 4, grammar: "기 위해서",
    senses: [{ meaning: "để", groupId: "purpose_general" }],
    synonymPatterns: ["(으)려고", "고자"],
    examples: [
    ...
    ], notes: " Bắt buộc chủ ngữ vế 1 và vế 2 phải giống nhau. (Nếu khác chủ ngữ phải dùng 게/도록). Constraint: Chủ ngữ vế 1 == Chủ ngữ vế 2. Động từ đứng trước phải là nguyên thể, cấm chia thì (았/었). KHÔNG đi với đuôi câu mệnh lệnh/rủ rê ở vế sau (-(으)세요, -자, -(으)ㅂ시다). Đây là điểm phân biệt cốt lõi với (으)려면.",
    ownExamples: [
      { sentence: "요즘 살을 <b>빼기 위해서</b> 열심히 운동을 하고 있다.", translation: "Dạo này tôi đang chăm chỉ tập thể dục để giảm cân." }
    ]
  },
  {
    // THAY ĐỔI: Xóa "기 위해서" khỏi synonymPatterns — hai cấu trúc đối nghịch nhau về đuôi câu.
    id: 5, grammar: "(으)려면",
    senses: [{ meaning: "nếu muốn... thì (điều kiện mục tiêu)", groupId: "condition_intent" }],
    synonymPatterns: ["고 싶으면", "려거든", "자면"],
    examples: [
    ...
    ], notes: " Đuôi câu bắt buộc phải là dạng mệnh lệnh, rủ rê, khuyên bảo (-(으)세요, -아/어야 하다, -는 게 좋다...). Tuyệt đối không dùng thì quá khứ ở đuôi câu. Constraint: Vế sau BẮT BUỘC là mệnh lệnh, khuyên bảo. Không thay thế bằng 기 위해서 vì 기 위해서 cấm đuôi mệnh lệnh — logic đối nghịch.",
    ownExamples: [
      { sentence: "외국에서 생활을 <b>잘하려면</b> 그 나라의 문화를 이해하는 게 중요하다.", translation: "Để sống tốt ở nước ngoài, việc hiểu văn hóa nước đó là rất quan trọng." }
    ]
  },
  {
    // THAY ĐỔI: Thêm Constraint chi tiết về sự khác biệt với 고서도.
    // 고서도 nhấn mạnh hành động đã hoàn tất (고 = hoàn tất). (으)면서도 là đồng thời.
    // Không phải mọi câu dùng (으)면서도 đều có thể thay bằng 고서도 và ngược lại.
    id: 6, grammar: "(으)면서(도)",
    ...
    ], notes: " Bắt buộc vế 1 và vế 2 phải CÙNG MỘT chủ ngữ. Constraint: Chủ ngữ vế 1 == Chủ ngữ vế 2. (으)면서도 = đồng thời (A và B xảy ra song song). 고서도 = tuần tự hoàn tất (A xong rồi mới B, nhưng vẫn bất chấp). Chỉ thay thế được khi hành động vế 1 có thể hiểu là đã hoàn tất; với hành động kéo dài song song thực sự (VD: 음악을 들으면서도 공부했다) KHÔNG thay bằng 고서도.",
    ownExamples: [
      { sentence: "친구가 곤란할까 봐 그 사실을 <b>알면서</b> 모른 척했다.", translation: "Sợ bạn gặp khó, dù biết chuyện đó nhưng tôi giả vờ không biết." }
    ]
  },
  {
    ...
    synonymPatterns: ["(으)ㄹ 수도 있다", "(으)ㄹ 텐데", "(으)ㄹ까 봐(서)"],
    examples: [
  ...
  {
    // THAY ĐỔI: Xóa "지 않았을 것이다" khỏi synonymPatterns.
    // 리가 없다 = phủ định TUYỆT ĐỐI ("Không có lý nào...").
    // 지 않았을 것이다 = PHỎNG ĐOÁN ("Chắc là đã không...") — hoàn toàn khác sắc thái và cấu trúc.
    ...
    ], notes: " Phủ định tuyệt đối khả năng ('Không có lý nào'). Khác hoàn toàn với 지 않았을 것이다 (ID 123) là phỏng đoán mềm. Constraint: Không thay thế bằng 지 않았을 것이다 — hai cấu trúc khác về bản chất (phủ định tuyệt đối vs phỏng đoán)."
  },
  {
    ...
    notes: "Đáng để trải nghiệm, giới thiệu. Constraint: KHÔNG thay thế bằng (으)ㄹ 수 있다 — 만하다 = đáng để làm (worthiness); 수 있다 = có thể/năng lực — hai cái khác nghĩa hoàn toàn."
  },
  {
  ...
  {
    // THAY ĐỔI: Xóa "느라고" khỏi synonymPatterns.
    // 는 바람에 = ngoại cảnh tác động bất ngờ (VD: 비가 오는 바람에).
    // 느라고 = hành động chủ đích của con người tốn thời gian/công sức.
    // Không thể thay 1-1 (VD: 비가 오느라고 -> SAI hoàn toàn).
    id: 12, grammar: "는 바람에",
    senses: [{ meaning: "vì, tại vì", groupId: "reason_negative" }],
    synonymPatterns: ["는 통에", "ㄴ/은 탓에"],
    examples: [
    ...
    ], notes: " Chỉ dùng cho kết quả tiêu cực và sự kiện bất ngờ, đột xuất (không dùng cho tình trạng kéo dài). Constraint: Chủ thể gây ra là NGOẠI CẢNH hoặc sự kiện bất ngờ. KHÔNG thay thế bằng 느라고 vì 느라고 đòi hỏi chủ ngữ tích cực thực hiện hành động có chủ đích; với nguyên nhân là điều kiện tự nhiên (비가 오다) 느라고 SAI hoàn toàn."
  },
  {
  ...
  },
  {
    ...
    senses: [{ meaning: "do...nên", groupId: "reason_extreme" }],
    ...
    ], notes: " Động từ kết hợp với -은/는 나머지, Tính từ kết hợp với -(으)ㄴ 나머지. Thường đi kèm các từ chỉ cảm xúc/hành động thái quá (흥분한 나머지, 놀란 나머지). Khác với 는 바람에 (bị ngoại cảnh tác động bất ngờ): 나머지 chỉ việc chủ thể tự làm quá mức dẫn đến hậu quả."
  },
  {
  ...
  },
  {
    ...
    ], notes: " Constraint: Khi thay bằng 고도, chủ thể vế 1 phải thực hiện Động từ hành động (không dùng với Tính từ — VD: 예쁜데도 KHÔNG thể đổi thành 예쁘고도)."
  },
  {
  ...
  },
  {
    ...
    ], notes: " Chỉ kết hợp với Động từ. Không dùng với Tính từ (Ví dụ: 예쁘고도 -> SAI, phải dùng 예쁜데도). Constraint: Chỉ dùng với Động từ hành động."
  },
  {
    id: 19, grammar: "도록",
    ...
    ], notes: "Có 3 nghĩa: (1) 'đến tận / đến mức' (VD: 밤새도록 - suốt đêm); (2) 'để' - mục đích (VD: 잊지 않도록 메모해요); (3) 'để cho' - sai khiến, khiến ai đó làm gì (VD: 학생들이 조용히 하도록 했다 - Tôi đã khiến học sinh giữ im lặng). Constraint: Khi thay bằng (으)ㄹ 때까지, chỉ áp dụng ở nghĩa 1 (giới hạn thời gian). Nghĩa 2 và 3 KHÔNG thay thế được."
  },
  {
    id: 197, grammar: "도록",
  ...
  },
  {
    ...
    ], notes: "Nghĩa cốt lõi: giữ nguyên trạng thái A mà làm thêm B (không thay đổi trạng thái). 고 và 채(로) không phải lúc nào cũng thay thế được; 채(로) nhấn mạnh trạng thái được duy trì. Constraint: Chỉ đi với Động từ. Chủ ngữ 2 vế phải giống nhau."
  },
  {
  ...
  },
  {
    ...
    ], notes: " Constraint: Chỉ gắn sau Động từ hành động (không dùng với Tính từ — VD: 비싸 봤자 có thể dùng nhưng 비싸나 마나 không tự nhiên). Khi thay thế từ 는/나 마나 sang 봤자, chú ý 봐야 linh hoạt hơn với cả Tính từ nhất định. 물어볼 것도 없이 (ID 116) là cụm cố định chỉ biểu hiện sự hiển nhiên — không phải synonym thay thế tự do."
  },
  {
    id: 25, grammar: "든지",
    senses: [{ meaning: "hoặc / bất kể... hay...", groupId: "choice_any" }],
    synonymPatterns: [],
    examples: [
    ...
    ], notes: "Bản chất: Dùng để lựa chọn giữa nhiều phương án, không quan trọng chọn cái nào. KHÔNG mang tính giả định nhượng bộ. Tuyệt đối KHÔNG đồng nghĩa với 아/어도 (Nhượng bộ trung lập: Dù A xảy ra vẫn làm B) và KHÔNG đồng nghĩa với 아/어 봤자 (Nhượng bộ tiêu cực: Dù làm A cũng vô ích). Dùng sai logic trong văn viết TOPIK sẽ bị trừ điểm nặng."
  },
  {
    id: 26, grammar: "(으)ㄹ 정도로",
    senses: [{ meaning: "đến mức", groupId: "extent_degree" }],
    synonymPatterns: ["만큼", "(으)ㄹ 지경이다"],
    examples: [
  ...
  },
  {
    ...
    synonymPatterns: ["지 않을 수 없다", "아/어야 할 뿐이다"],
    examples: [
    ...
    notes: "Nhấn mạnh không còn lựa chọn khác (bất khả kháng). Constraint: KHÔNG thay thế bằng 아/어야 하다 — 수밖에 없다 nhấn mạnh tính bất khả kháng tuyệt đối; 아/어야 하다 chỉ là nghĩa vụ thông thường, sắc thái nhẹ hơn nhiều — hai cái không thay thế 1-1 trong mọi ngữ cảnh."
  },
  {
    ...
    ], notes: " Đuôi câu KHÔNG được chia mệnh lệnh, rủ rê (-(으)세요, -자). Nếu đuôi câu là mệnh lệnh, phải dùng -(으)ㄹ지도 모르니까. Constraint: Cấm đuôi câu mệnh lệnh/rủ rê sau (으)ㄹ까 봐."
  },
  {
    // THAY ĐỔI: Bỏ "는 대로" (mơ hồ — ID 36 nghĩa 1 vs ID 196 nghĩa 2) khỏi synonymPatterns.
    // Thay bằng tham chiếu rõ ràng đến "는 대로 (nghĩa 2 - ngay khi)" là ID 196.
    id: 30, grammar: "자마자",
    senses: [{ meaning: "ngay sau khi", groupId: "immediate" }],
    synonymPatterns: ["는 대로 (nghĩa 2: ngay khi)", "면 바로", "기가 무섭게", "기가 바쁘게"],
    examples: [
    ...
    ], notes: " Động từ đứng trước 자마자 luôn ở nguyên thể, KHÔNG chia thì quá khứ (았/었). Constraint: Cấm chia quá khứ trước 자마자. 는 대로 (nghĩa 2) = 'ngay khi, vừa làm xong thì làm ngay' (chủ động, có kế hoạch); 자마자 = 'vừa xong thì xảy ra' (tức thì, tự nhiên hơn). Chú ý: '는 대로' trong synonymPatterns này là NGHĨA 2 (ID 196), KHÔNG phải nghĩa 1 (theo như / ID 36)."
  },
  {
    // THAY ĐỔI: Xóa "는 김에" khỏi synonymPatterns.
    // 는 길에 CHỈ dùng với động từ di chuyển. 는 김에 dùng với MỌI động từ.
    // Chúng không thay thế 1-1: 마트에 가는 김에 (tốt) nhưng 마트에 가는 길에 (cũng OK chỉ vì đây là đi lại).
    // Với động từ không phải di chuyển: 청소하는 길에 -> SAI; 청소하는 김에 -> ĐÚNG.
    id: 31, grammar: "는 길에",
    ...
    ], notes: " CHỈ kết hợp với động từ di chuyển. Constraint: Vế trước BẮT BUỘC là Động từ di chuyển (가다, 오다, 다니다...). Không thay thế bằng 는 김에 vì 는 김에 dùng được với MỌI động từ — hai cái không thay thế 1-1 khi hành động không phải di chuyển."
  },
  {
  ...
  },
  {
    ...
    synonymPatterns: ["(으)ㄹ 따름이다", "에 불과하다", "에 지나지 않다", "에 다름 아니다"],
    examples: [
    ...
    ], notes: " Constraint: Khi thay bằng 에 불과하다 (ID 63), chú ý cú pháp: 변명일 뿐이다 → 변명에 불과하다 (phải bỏ 이다, thêm 에). Không thay thế trực tiếp y nguyên mặt chữ."
  },
  {
  ...
  {
    // THAY ĐỔI: Xóa "자마자" và "기가 무섭게" khỏi synonymPatterns của nghĩa 1.
    // Hai cái đó thuộc nghĩa 2 (ID 196). Nghĩa 1 "theo như / y hệt" hoàn toàn khác nghĩa 2 "ngay khi".
    id: 36, grammar: "는 대로",
    senses: [{ meaning: "theo như, làm y hệt (nghĩa 1)", groupId: "according" }],
    ...
    ], notes: " 는 대로 (Nghĩa 1): 'Theo như / y như' → đồng nghĩa với 는 것처럼, 는 바와 같이. Constraint: Tuyệt đối KHÔNG nhầm lẫn với 는 대로 nghĩa 2 (ID 196 = 'ngay khi'). Hai nghĩa phải được xử lý độc lập. Không thay thế bằng 자마자 hay 기가 무섭게 (đó là synonym của nghĩa 2)."
  },
  {
    // THAY ĐỔI: ID 196 - Thêm "자마자", "기가 무섭게", "면 바로" vào synonymPatterns nghĩa 2.
    id: 196, grammar: "는 대로",
    senses: [{ meaning: "ngay khi, vừa...liền (nghĩa 2)", groupId: "immediate" }],
    ...
    ], notes: " 는 대로 (Nghĩa 2): 'Ngay khi / vừa xong thì' → đồng nghĩa với 자마자. Thường dùng với các kế hoạch, dự định. Constraint: Tuyệt đối KHÔNG nhầm lẫn với 는 대로 nghĩa 1 (ID 36 = 'theo như'). Hai nghĩa phải được xử lý độc lập."
  },
  {
    ...
    ], notes: "에 달려 있다: gắn sau Danh từ (N에 달려 있다). 기에 달려 있다: gắn sau Động từ (V기에 달려 있다). Hai dạng cùng nghĩa, chỉ khác cú pháp. Constraint: Khi thay bằng 기 나름이다, phải đổi N-에 → V-기 (VD: 방법에 달려 있다 → 하기 나름이다). Không thay thế y nguyên mặt chữ."
  },
  {
  ...
  },
  {
    ...
    notes: "Constraint (thay thế chuỗi): 듯이 gắn trực tiếp vào thân Động từ/Tính từ (V/A-듯이). 는 것처럼 gắn sau vĩ tố định ngữ (V-는/은/을 것처럼). Khi thay từ 것처럼 sang 듯이, thuật toán phải XÓA vĩ tố 는/은/을 đứng trước (VD: 먹는 것처럼 → 먹듯이, tuyệt đối không để 먹는듯이). Constraint: KHÔNG liệt kê cả 것처럼 lẫn 는 것처럼 — hai cái là một, chỉ dùng dạng đầy đủ 는 것처럼."
  },
  {
    id: 41, grammar: "기도 하고",
    ...
    ], notes: " Thường đi theo cặp liệt kê 2 hành động song song (V-기도 하고 V-기도 하다)."
  },
  {
  ...
  },
  {
    ...
    ], notes: " Không thay thế tự do cho '았/었는데'. Chủ ngữ vế 1 của '더니' thường là ngôi thứ 2 hoặc 3 (quan sát người khác), KHÔNG dùng ngôi thứ 1 (내가) trong câu tương phản. Chỉ dùng khi người nói đã TRỰC TIẾP quan sát/trải nghiệm ở quá khứ. Constraint: Chủ ngữ vế 1 phải là ngôi 2 hoặc 3 (KHÔNG là 나/저 trong câu tương phản thuần túy)."
  },
  {
    id: 198, grammar: "더니",
    ...
    ], notes: "Chỉ dùng khi người nói đã TRỰC TIẾP quan sát/trải nghiệm ở quá khứ. Nghĩa nguyên nhân đồng nghĩa với 아서/어서 trong ngữ cảnh quan sát. Constraint: Chủ ngữ quan sát phải là ngôi 3 (quan sát người khác)."
  },
  {
    id: 199, grammar: "더니",
  ...
  },
  {
    ...
    ], notes: "Dùng khi người nói suy đoán từ bằng chứng quan sát được (nghe/thấy kết quả). Constraint: KHÔNG dùng cho chủ ngữ ngôi thứ nhất về chính mình (내가 피곤한가 봐요 -> SAI; 친구가 피곤한가 봐요 -> ĐÚNG). Đây là điểm phân biệt hay xuất hiện trong đề TOPIK II."
  },
  {
  ...
  {
    // THAY ĐỔI: Xóa "(으)러" khỏi synonymPatterns.
    // (으)러 CHỈ đi với động từ di chuyển ở vế sau. (으)려고 dùng được với mọi động từ.
    // Không thay thế 1-1 trong câu không có động từ di chuyển.
    id: 50, grammar: "(으)려고",
    senses: [{ meaning: "định, để (ý định)", groupId: "purpose_general" }],
    synonymPatterns: ["기 위해서", "고자"],
    ownExamples: [
      { sentence: "건강해지<b>려고</b> 매일 아침 운동을 시작했다.", translation: "Để trở nên khỏe mạnh, tôi bắt đầu tập thể dục mỗi sáng." }
    ], notes: " Chủ ngữ 2 vế bắt buộc ĐỒNG NHẤT. Constraint: Chủ ngữ vế 1 == Chủ ngữ vế 2. Động từ đứng trước phải là nguyên thể, cấm chia thì (았/었). Tuyệt đối KHÔNG chia đuôi câu mệnh lệnh, rủ rê (-(으)세요, -자, -(으)ㅂ시다) ở vế sau. Không thay thế bằng (으)러 nếu vế sau không phải động từ di chuyển."
  },
  {
    id: 51, grammar: "지만",
  ...
  },
  {
    ...
    synonymPatterns: ["는 바람에", "ㄴ/은 탓에"],
    ownExamples: [
      { sentence: "아이들이 <b>떠드는 통에</b> 집중해서 일을 할 수가 없었다.", translation: "Vì bọn trẻ ồn ào nên tôi không thể tập trung làm việc." }
    ], notes: "Mang ý nghĩa hỗn loạn, náo loạn; kết quả thường tiêu cực. Constraint: Chủ thể gây ra là tình huống ồn ào/hỗn loạn. Khi thay bằng 느라고, chú ý 느라고 đòi hỏi hành động có chủ đích và chủ ngữ đồng nhất — không thay thế khi chủ ngữ khác nhau."
  },
  {
    id: 54, grammar: "ㄴ/은 탓에",
    senses: [{ meaning: "vì, do (đổ lỗi)", groupId: "reason_negative" }],
    synonymPatterns: ["는 바람에", "는 통에"],
    ownExamples: [
      { sentence: "늦잠을 <b>잔 탓에</b> 중요한 회의에 늦어 버렸다.", translation: "Do ngủ quên nên tôi đã đến trễ cuộc họp quan trọng." }
    ], notes: "Mang sắc thái đổ lỗi; nguyên nhân dẫn đến kết quả xấu. Constraint: Khi thay bằng 느라고, phải đảm bảo cùng chủ ngữ và hành động có chủ đích; không thay khi nguyên nhân là trạng thái tự nhiên."
  },
  {
    id: 55, grammar: "느라고",
    ...
    ], notes: " Bắt buộc cùng chủ ngữ ở cả 2 vế. Constraint: Chủ ngữ vế 1 == Chủ ngữ vế 2. CHỈ đi với động từ chỉ hành động tiêu tốn thời gian/công sức (KHÔNG dùng với động từ trạng thái hay thụ động như 감기에 걸리느라고 -> SAI). Động từ đứng trước phải là nguyên thể, cấm chia thì (았/었). KHÔNG chia đuôi câu mệnh lệnh, rủ rê. KHÔNG thay thế bằng 는 바람에 khi nguyên nhân là hành động chủ đích của chủ thể chính (bị nhầm ngược)."
  },
  {
    id: 56, grammar: "만큼",
    senses: [{ meaning: "bằng, nhiều như, đến mức", groupId: "extent_degree" }],
    synonymPatterns: ["(으)ㄹ 정도로", "(으)ㄹ 지경이다", "(으)ㄹ 정도이다"],
    ownExamples: [
  ...
  },
  {
    ...
    ], notes: "Thường dùng khi bổ sung thêm đặc điểm cùng chiều. Không đưa 려니와/거니와 và 뿐더러 vào synonymPatterns vì lệch văn phong nói-viết."
  },
  {
    id: 58, grammar: "(으)ㄹ지라도",
    senses: [{ meaning: "dù, cho dù (nhượng bộ giả thiết)", groupId: "concession_general" }],
    synonymPatterns: ["더라도", "아/어/여도"],
    ownExamples: [
  ...
  },
  {
    ...
    synonymPatterns: ["(으)ㄹ 수밖에 없다", "아/어야 할 뿐이다"],
    ownExamples: [
      { sentence: "그 소식을 듣고 울<b>지 않을 수 없었다</b>.", translation: "Nghe tin đó, tôi không thể không khóc." }
    ], notes: " Phủ định kép → nghĩa khẳng định mạnh; tương đương 수밖에 없다. Constraint: Khi thay bằng 아/어야 하다, sắc thái bắt buộc nhẹ hơn — chỉ thay được khi ngữ cảnh không cần nhấn mạnh tính bất khả kháng. Không thay 1-1 trong mọi trường hợp."
  },
  {
    id: 62, grammar: "기가 무섭게",
    senses: [{ meaning: "ngay tức khắc, vừa...đã ngay", groupId: "immediate" }],
    synonymPatterns: ["자마자", "는 대로 (nghĩa 2: ngay khi)", "면 바로", "기가 바쁘게"],
    ownExamples: [
  ...
  },
  {
    ...
    ], notes: " '에 불과하다' gắn sau danh từ + 에. Constraint: Khi thay bằng '일 뿐이다', bắt buộc phải bỏ tiểu từ '에' (VD: 핑계에 불과하다 → 핑계일 뿐이다). Nhấn mạnh sự hạn chế, tầm thường; thường hàm ý phê phán."
  },
  {
  ...
  },
  {
    ...
    synonymPatterns: ["듯이", "는 것과 같이", "는 바와 같이"],
    ownExamples: [
  ...
  },
  {
    ...
    synonymPatterns: ["기 위해(서)", "(으)려고"],
    ownExamples: [{ sentence: "이 문제를 해결하<b>고자</b> 회의를 열었습니다.", translation: "Chúng tôi đã mở cuộc họp để giải quyết vấn đề này." }],
    notes: "Chủ ngữ 2 vế bắt buộc ĐỒNG NHẤT. Constraint: Chủ ngữ vế 1 == Chủ ngữ vế 2. Tuyệt đối KHÔNG chia đuôi câu mệnh lệnh, rủ rê (-(으)세요, -자, -(으)ㅂ시다) ở vế sau. Cấm chia thì quá khứ/tương lai (았/었/겠) trước 고자. Thực hiện hành động để đạt mục đích phía trước, thường tốn công sức, văn viết/vĩ mô. Constraint: KHÔNG thay thế bằng 도록 — 도록 cho phép khác chủ ngữ và dùng được nghĩa sai khiến; 고자 bắt buộc cùng chủ ngữ và cấm mệnh lệnh — hai cái có constraint ngược nhau về chủ ngữ."
  },
  {
    id: 71, grammar: "(으)러",
    ...
    notes: " Constraint: Vế sau BẮT BUỘC là Động từ di chuyển (가다, 오다, 다니다, 도착하다...). Không thể thay thế ngược cho '(으)려고' nếu vế sau không phải hành động di chuyển. Constraint: Chủ ngữ vế 1 == Chủ ngữ vế 2."
  },
  {
  ...
  },
  {
    ...
    synonymPatterns: ["(으)ㄴ 후에", "(으)ㄴ 다음에"],
    ownExamples: [{ sentence: "밥을 먹<b>고 나서</b> 양치를 했다.", translation: "Sau khi ăn cơm xong, tôi đã đánh răng." }],
    notes: "Kết thúc hoàn toàn hành động trước rồi mới đến hành động sau. Constraint: Chỉ gắn sau Động từ (không gắn sau Danh từ trực tiếp). Nếu có Danh từ (VD: 졸업 후에), KHÔNG được thay bằng 고 나서 trực tiếp — phải thêm Động từ (졸업을 하고 나서)."
  },
  {
    // THAY ĐỔI: Xóa "는 길에" khỏi synonymPatterns.
    // 다가 và 는 길에 chỉ tương đương với động từ di chuyển — không thay thế 1-1 toàn bộ.
    id: 75, grammar: "다가",
    ...
    notes: " Bị ngắt quãng, rẽ hướng sang hành động khác. Constraint: 다가 có phạm vi rộng hơn 는 길에 (mọi động từ). 는 길에 CHỈ dùng với động từ di chuyển. Không đặt 는 길에 vào synonymPatterns vì nếu thay 1-1 sẽ tạo câu sai với động từ không di chuyển (VD: 책을 읽는 길에 -> SAI)."
  },
  {
    ...
    notes: "Thường đi kèm với khoảng thời gian. Constraint: Bắt buộc phải có cụm thời gian cụ thể sau 지 (1년, 3개월, 오래...). Động từ đứng trước phải chia -(으)ㄴ 지 (quá khứ hoàn thành)."
  },
  {
  ...
  },
  {
    ...
    senses: [{ meaning: "có lẽ vì... nên", groupId: "reason_guess" }],
    synonymPatterns: ["아서/어서 그런지"],
    examples: [
      { sentence: "잠을 못 <b>잤는지</b> 피곤해 보여요.", translation: "Có lẽ vì không ngủ được nên trông có vẻ mệt." }
    ], notes: "Dùng khi không chắc chắn về nguyên nhân; phỏng đoán nhẹ. Thường đi kèm với dạng rút gọn là -(으)ㄴ/는지."
  },
  {
    id: 80, grammar: "(으)니까",
    senses: [{ meaning: "bởi vì (lý do) / sau khi (nhận ra)", groupId: "reason_command" }],
    synonymPatterns: ["(으)ㄹ 테니까"],
    ownExamples: [{ sentence: "날씨가 추우<b>니까</b> 따뜻하게 입으세요.", translation: "Vì thời tiết lạnh nên hãy mặc ấm nhé." }],
    notes: "Constraint: Nếu đuôi câu là mệnh lệnh, rủ rê (-(으)세요, -(으)ㅂ시다), TUYỆT ĐỐI KHÔNG thay bằng 아/어서 hay 기 때문에. Vế sau thường là câu mệnh lệnh, rủ rê, hoặc dùng sau khi làm gì thì nhận ra điều gì. Constraint: KHÔNG thay thế bằng (으)ㄴ/는 이상 — 이상 thuộc nhóm điều kiện tất yếu (condition_restrict), khác nhóm ngữ nghĩa hoàn toàn với 니까 (nguyên nhân trực tiếp). Sắc thái phỏng đoán nguyên nhân mơ hồ như 아서/어서 그런지 (ID 177) KHÔNG đồng nghĩa — hai cái khác hoàn toàn về mức độ chắc chắn."
  },
  {
  ...
  },
  {
    ...
    synonymPatterns: ["(으)려면", "려거든", "자면"],
    ownExamples: [{ sentence: "시험에 합격하<b>고 싶으면</b> 열심히 공부해라.", translation: "Nếu muốn thi đậu thì hãy học chăm chỉ vào." }],
    notes: "Tương đương (으)려면. Constraint: Vế sau BẮT BUỘC là mệnh lệnh hoặc lời khuyên."
  },
  {
    id: 83, grammar: "거든(요)",
  ...
  },
  {
    ...
    notes: "Giả định điều khó hoặc không thể xảy ra trong thực tế (giả định phản thực tế). Constraint: Tính từ dùng -다면, Động từ dùng -ㄴ/는다면. Constraint: KHÔNG thay thế tự do bằng (으)면 — (으)면 là giả định thông thường có thể xảy ra; 다면 chỉ dùng cho giả định phản thực tế hoặc điều gần như không thể. Thay nhầm sẽ đổi hoàn toàn sắc thái câu."
  },
  {
    id: 85, grammar: "(으)면",
  ...
  },
  {
    ...
    notes: " Chỉ dùng để nối Động từ và Tính từ. Nếu muốn nối Danh từ, phải dùng (이)나. Lựa chọn cụ thể 1 trong 2. Constraint: KHÔNG đồng nghĩa với 든지 (bất kể là gì, không quan tâm) — hai cái khác nhau về mức độ quan tâm đến sự lựa chọn. Không thay thế lẫn nhau."
  },
  {
    id: 89, grammar: "(으)ㄹ수록",
  ...
  },
  {
    ...
    notes: " '기 나름이다' gắn sau Động từ (V-기). Constraint: Nếu muốn dùng '에 달려 있다', phải biến đổi động từ thành danh từ (N-에) hoặc dùng dạng 'V-기에 달려 있다'. Không thay thế trực tiếp y nguyên mặt chữ. Phụ thuộc vào cách thực hiện mà kết quả sẽ thay đổi."
  },
  {
    ...
    notes: " '(으)ㄹ 줄 알다' chỉ dùng cho những kỹ năng phải học mới biết (như bơi lội, nấu ăn, lái xe, ngoại ngữ). Còn (으)ㄹ 수 있다 dùng cho mọi trường hợp (có thời gian không, có tiền không...). Không thể thay '갈 수 있어요?' thành '갈 줄 알아요?'. Constraint: Chỉ thay bằng (으)ㄹ 줄 알다/모르다 với kỹ năng có thể học được. Khi thêm 도 (수도 있다) mới mang nghĩa phỏng đoán mờ nhạt."
  },
  {
    ...
    notes: "Diễn tả sự hối hận vì một việc mình đã thực hiện trong quá khứ. Trái nghĩa: (으)ㄹ걸 그랐다 (hối tiếc vì KHÔNG làm). Hai cấu trúc này đối lập nhau, thường xuất hiện trong đề TOPIK để phân biệt."
  },
  {
    ...
    notes: "Điều tiêu cực suýt xảy ra nhưng may mắn không sao. Constraint: Luôn dùng ở dạng quá khứ (았/었). Chỉ dùng cho kết quả tiêu cực."
  },
  {
  ...
  },
  {
    ...
    notes: "Thói quen trong hiện tại (곤 하다) hoặc quá khứ (곤 했다); dùng được cho cả thói quen tốt lẫn xấu. Constraint: KHÔNG thay thế bằng 기 일쑤이다 trong ngữ cảnh tích cực — 기 일쑤이다 chỉ dùng cho thói quen/lỗi lặp đi lặp lại mang tính tiêu cực. VD: 공원에서 놀곤 했다 KHÔNG thể thay bằng 기 일쑤이다 vì chơi ở công viên là tích cực."
  },
  {
    id: 96, grammar: "는 편이다",
  ...
  },
  {
    ...
    notes: " Có 2 chức năng: (1) Thay thế hành động (Không làm A mà chuyển sang làm B). (2) Bù trừ tính chất (Có ưu điểm A nhưng bù lại có khuyết điểm B). Hành động sau thay thế cho hành động trước."
  },
  {
    id: 99, grammar: "게 되다",
    ...
    notes: "Kết quả có được do yếu tố bên ngoài tác động vào. Khác 아/어지다: 게 되다 = kết quả do tác động bên ngoài (nhấn mạnh điểm đến); 아/어지다 = quá trình thay đổi tự nhiên."
  },
  {
    // THAY ĐỔI: Xóa "지 않을 수 없다" khỏi synonymPatterns.
    // 지 않을 수 없다 là phủ định kép mang sắc thái bất khả kháng rất mạnh.
    // 아/어야 하다 là nghĩa vụ thông thường. Hai cái không thay thế 1-1 trong mọi ngữ cảnh.
    ...
    notes: " Diễn tả nghĩa vụ, sự bắt buộc. Constraint: Khi cần nhấn mạnh tính bất khả kháng (không còn cách nào khác), dùng (으)ㄹ 수밖에 없다 hoặc 지 않을 수 없다. 아/어야 하다 là nghĩa vụ thông thường — sắc thái nhẹ hơn nhiều. Không thay thế 1-1 với 지 않을 수 없다 trong mọi ngữ cảnh."
  },
  {
    id: 101, grammar: "는 동안",
    ...
    notes: "Dùng cho mọi sinh hoạt bình thường, nhấn mạnh một khoảng thời gian dài liên tục. Chủ ngữ có thể giống hoặc khác nhau. Constraint: KHÔNG thay bằng 는 사이에 khi chủ ngữ 2 vế GIỐNG NHAU — 는 사이에 bắt buộc chủ ngữ 2 vế phải KHÁC NHAU và vế sau là sự thay đổi bất ngờ. Constraint: KHÔNG thay bằng 는 가운데 trong sinh hoạt thường ngày (như 밥을 먹는 동안) — 는 가운데 chỉ dùng với bối cảnh trang trọng/áp lực."
  },
  {
    id: 102, grammar: "마다",
  ...
  },
  {
    ...
    notes: "Tương đương 뿐이다, nhưng mang sắc thái khiêm tốn hơn; thường dùng trong văn viết hoặc lời nói trang trọng. Constraint: Khác 에 불과하다: 따름이다 gắn sau vị ngữ/động từ; 에 불과하다 gắn sau danh từ + 에 — cú pháp khác nhau, không thay thế trực tiếp."
  },
  {
    id: 104, grammar: "는 김에",
    ...
    notes: " Nhân cơ hội đang thực hiện hành động A thì làm thêm B. Constraint: Khác 는 길에 (tiện đường di chuyển): 는 김에 dùng với mọi hành động, không chỉ di chuyển — không thay thế lẫn nhau khi hành động không phải di chuyển. Khác (으)ㄹ 겸: 겸 thường đi theo cặp song song (V겸 V겸); 는 김에 chỉ 1 hành động cơ sở nên không lưu 겸 làm synonym thay thế 1-1."
  },
  {
    ...
    notes: " Rất trang trọng (văn báo chí). Constraint: CHỈ dùng cho 'bối cảnh', 'tình thế' (thường là khó khăn, áp lực, VD: 어려운 가운데). KHÔNG thay thế cho '는 동안' trong giao tiếp thường ngày (như 밥을 먹는 동안 không thể đổi thành 밥을 먹는 가운데). Mang sắc thái trang trọng (văn viết)."
  },
  {
    id: 106, grammar: "는 중에",
    ...
    notes: " Nhấn mạnh một tiến trình đang diễn ra giữa chừng thì có sự việc khác xen vào, thường dùng với danh từ chỉ hoạt động (VD: 회의 중에, 수업 중에). Constraint: KHÔNG thay '수업하는 동안' bằng '수업하는 가운데'. Vế sau thường là hành động bất chợt xen ngang."
  },
  {
  ...
  },
  {
    ...
    synonymPatterns: ["고 나서", "(으)ㄴ 다음에"],
    ownExamples: [{ sentence: "식사를 한 <b>후에</b> 약을 드세요.", translation: "Hãy uống thuốc sau khi ăn xong." }],
    notes: " Constraint: Nếu trước đó là Danh từ (N + 후에), KHÔNG ĐƯỢC thay bằng '고 나서'. Phải chuyển thành Động từ (N을/를 하고 나서) mới được thay. Sau khi hoàn thành A thì mới B. Tương đương 고 나서 (ID 74) nhưng 후에 dùng được sau cả danh từ (졸업 후에); 고 나서 chỉ sau động từ."
  },
  {
  ...
  },
  {
    ...
    notes: " Constraint: Nghĩa 'như/theo như' chỉ đi hạn chế với một số động từ nhận thức (알다, 보다, 듣다, 느끼다, 짐작하다...). KHÔNG thay thế tự do cho '는 것처럼' với các động từ sinh hoạt. Kết hợp với một số động từ thông dụng tạo thành cụm cố định: 알다시피 (như bạn đã biết), 보다시피 (như bạn đã thấy). Với các động từ hành động khác mang nghĩa 'gần như, hầu như'. Tránh dùng cùng động từ ở cả hai vế."
  },
  {
  ...
  },
  {
    ...
    notes: "Thay đổi trạng thái một cách tự nhiên (thường dùng với tính từ). Khác 게 되다 (ID 99): 아/어지다 = quá trình tự nhiên; 게 되다 = kết quả do tác động bên ngoài."
  },
  {
    id: 114, grammar: "(으)ㄹ 지경이다",
    senses: [{ meaning: "đến mức/nỗi (mức độ cực đoan, thường tiêu cực)", groupId: "extent_degree" }],
    synonymPatterns: ["(으)ㄹ 정도이다"],
  ...
  },
  {
    ...
    notes: "Diễn đạt sự vô nghĩa của hành động. Khác với (나) 마나 (biết trước kết quả 100%), 어/아 봤자 mang ý nghĩa kết quả vô ích nhưng chưa chắc đã biết trước hoàn toàn. Constraint: Khi thay bằng (나) 마나, chỉ dùng với Động từ hành động (không dùng với Tính từ)."
  },
  {
    // THAY ĐỔI: Xóa "두말할 것도 없이" khỏi synonymPatterns.
    // (으)ㄹ 것도 없이 gắn sau Động từ (V-(으)ㄹ 것도 없이).
    // 두말할 것도 없이 là trạng từ đứng độc lập ở đầu mệnh đề — cú pháp hoàn toàn khác.
    ...
    notes: "Hành động V thừa thãi vì kết quả đã quá hiển nhiên/chắc chắn. Là CONNECTOR — phải có mệnh đề sau. Dạng cố định hay gặp: 물어볼 것도 없이 (chẳng cần hỏi), 볼 것도 없이 (chẳng cần xem xét). Constraint: Gắn trực tiếp sau Động từ (V-(으)ㄹ 것도 없이). KHÔNG thay thế bằng 두말할 것도 없이 vì đó là trạng từ đứng độc lập (cú pháp hoàn toàn khác). Khác (나) 마나 / 봤자 (concession): 것도 없이 = hành động thừa thãi vì kết quả đã rõ."
  },
  {
  ...
  },
  {
    ...
    notes: "Nhấn mạnh sự cố ý bất chấp: đã nhận thức rõ ràng (알고) mà vẫn làm; sắc thái mạnh hơn (으)면서도. Constraint: 고서도 nhấn mạnh hành động tuần tự — hành động vế 1 đã hoàn tất, rồi mới làm vế 2 bất chấp. (으)면서(도) là đồng thời song song. Thứ tự mạnh dần: 고도 < (으)면서(도) < 고서도. Không thay thế tự do trong mọi ngữ cảnh."
  },
  {
  ...
  },
  {
    ...
    synonymPatterns: ["지 않았을 텐데"],
    ownExamples: [
      { sentence: "그 사람이라면 그런 말을 함부로 하<b>지 않았을 것이다</b>.", translation: "Nếu là người đó thì chắc đã không buông ra những lời như vậy đâu." }
    ],
    notes: "Phủ định trong quá khứ mang tính phỏng đoán; thường dùng trong lý luận hoặc biện hộ cho ai đó. Constraint: KHÔNG thay thế bằng (으)ㄹ 리가 없다 vì sắc thái hoàn toàn khác — 리가 없다 là phủ định tuyệt đối; 지 않았을 것이다 là phỏng đoán mềm."
  },
  {
  ...
  },
  {
    ...
    notes: " Constraint: Nếu trước đó là Danh từ (N + 다음에), KHÔNG ĐƯỢC thay bằng '고 나서'. Tương đương (으)ㄴ 후에; nhấn mạnh thứ tự trước-sau; dùng phổ biến trong văn nói."
  },
  {
  ...
  },
  {
    ...
    notes: " '겸' thường đi theo cặp V1-(으)ㄹ 겸 V2-(으)ㄹ 겸. Constraint: Khác '는 김에' (chỉ có 1 mục đích ban đầu sinh ra hành động 2): 겸 diễn đạt hai mục đích SONG SONG; 는 김에 là nhân tiện thêm. Không thể đổi chéo trực tiếp nếu câu không có cấu trúc song song."
  },
  {
  ...
  },
  {
    ...
    notes: "Giới hạn thời điểm kết thúc. Constraint: Khi thay bằng 도록, chỉ áp dụng ở nghĩa 'đến tận' của 도록. 도록 còn có nghĩa 'để' (mục đích) và 'để cho' (sai khiến) — không thay thế trong những nghĩa đó."
  },
  {
  ...
  },
  {
    ...
    notes: " Đuôi câu của '도록 하다' thường chia ở dạng mệnh lệnh, rủ rê (-(으)세요, -(으)ㅂ시다) khi khuyên bảo, hoặc -(으)겠습니다 khi thể hiện quyết tâm. 1. Khuyên bảo, yêu cầu nhẹ nhàng (mệnh lệnh gián tiếp). 2. Thể hiện sự quyết tâm, hứa hẹn của người nói."
  },
  {
  ...
  },
  {
    ...
    synonymPatterns: ["(으)ㄹ 뿐만 아니라", "(으)ㄴ/는 데다가", "(으)려니와/거니와", "은/는 말할 것도 없고", "(으)ㄹ 뿐더러"],
    ownExamples: [
  ...
  },
  {
    ...
    notes: "고 có 3 nghĩa chính: (1) Thứ tự: A rồi B; (2) Đồng thời: làm 2 việc cùng lúc; (3) Trạng thái: giữ nguyên trạng thái A trong khi B. Constraint: 고 (nghĩa trạng thái) và 채(로) không phải lúc nào cũng thay thế được nhau: 채(로) nhấn mạnh trạng thái được duy trì có chủ ý hoặc bất thường; 고 trung tính hơn. Trong thi cử cần xác định nghĩa đang dùng trước khi chọn cấu trúc thay thế."
  },
  {
    ...
    notes: " Mang sắc thái nhấn mạnh mạnh hơn (으)ㄴ 후에 / 고 나서. Thường đi kèm với đuôi câu chỉ khả năng hoặc kết quả muộn màng (비로소, 겨우). Nhấn mạnh việc kết quả chỉ xảy ra SAU KHI hoàn tất hành động; 야 tạo sắc thái 'mãi mới'."
  },
  {
    id: 153, grammar: "고 말다",
  ...
  },
  {
    ...
    notes: "Kết hợp (으)려고 하던 참이다 + 에; nhấn mạnh sự trùng hợp thời điểm; vế sau thường là điều xảy ra đúng lúc. Khác 려던 참이다 (đứng cuối câu): 려던 참에 nối sang vế sau."
  },
  {
    ...
    notes: "Thường kết quả tiêu cực; nhấn mạnh sự lặp đi lặp lại của lỗi/thói quen xấu. Constraint: Chỉ thay thế bằng 곤 하다 khi thói quen đó là tiêu cực. Khác 기 십상이다: 기 십상이다 (dễ bị) là nói về XÁC SUẤT xảy ra trong tương lai; 기 일쑤이다 (hay bị) là nói về TẦN SUẤT lặp lại đã xảy ra."
  },
  {
    id: 156, grammar: "기가 바쁘게",
    senses: [{ meaning: "vừa mới... đã ngay lập tức", groupId: "immediate" }],
    synonymPatterns: ["자마자", "기가 무섭게", "는 대로 (nghĩa 2: ngay khi)", "면 바로"],
  ...
  },
  {
    ...
    notes: "Diễn tả hành động xảy ra trong khoảnh khắc ngắn hoặc sơ hở. Constraint: Bắt buộc chủ ngữ 2 vế phải KHÁC NHAU. Thường vế sau là sự thay đổi đột ngột ngoài ý muốn. Khác 는 동안: 동안 dùng cho khoảng thời gian dài liên tục; 사이에 dùng cho khoảnh khắc ngắn hoặc sơ hở."
  },
  {
    id: 160, grammar: "노라면",
    senses: [{ meaning: "cứ làm mãi thì (sẽ có kết quả tương lai)", groupId: "future_result" }],
    synonymPatterns: ["다(가) 보면"],
  ...
  },
  {
    ...
    synonymPatterns: ["(으)ㄹ 나위가 없다", "두말할 것도 없이"],
    ...
    notes: " Constraint: Không thay thế y nguyên mặt chữ với '물론이고' do khác biệt về vị trí cú pháp (cuối câu vs giữa câu). Diễn đạt điều hiển nhiên, ai cũng đã biết. Khác 나위가 없다 (tuyệt đỉnh): 말할 것도 없다 = 'không cần nói vì ai cũng biết'; 나위가 없다 = 'không cần nói vì đã quá hoàn hảo'. Khác 물론이고: 말할 것도 없다 đứng độc lập (cuối câu hoặc đầu mệnh đề); 물론이고 nối 2 vế."
  },
  {
    id: 172, grammar: "면 바로",
    senses: [{ meaning: "hễ... thì ngay lập tức", groupId: "immediate" }],
    synonymPatterns: ["자마자", "기가 무섭게", "는 대로 (nghĩa 2: ngay khi)", "기가 바쁘게"],
  ...
  },
  {
    ...
    notes: " Constraint: Bắt buộc chủ ngữ của vế 1 và vế 2 PHẢI LÀ MỘT. Nếu 2 hành động do 2 người khác nhau thực hiện, phải dùng '는 동안'. Hai hành động xảy ra ĐỒNG THỜI. Phân biệt với (으)면서(도) (ID 6): (으)면서(도) mang nghĩa tương phản (mặc dù/nhưng)."
  },
  {
    id: 177, grammar: "아서/어서 그런지",
    senses: [{ meaning: "có lẽ vì... nên (phỏng đoán nguyên nhân)", groupId: "reason_guess" }],
    synonymPatterns: ["(으)ㄴ/는지 (모르다)"],
    ownExamples: [{ sentence: "잠을 못 자서 <b>그런지</b> 피곤해요.", translation: "Có lẽ vì không ngủ được nên tôi thấy mệt." }],
    notes: "Dùng khi không chắc chắn về nguyên nhân; phỏng đoán nhẹ. Constraint: KHÔNG dùng để thay thế cho (으)니까 — 니까 là nguyên nhân chắc chắn, thường đi với mệnh lệnh; 아서/어서 그런지 là phỏng đoán mơ hồ."
  },
  {
  ...
  },
  {
    ...
    notes: " Constraint: '에 지나지 않다' gắn sau N+에. Khi thay bằng '일 뿐이다', hệ thống bắt buộc phải bỏ tiểu từ '에' (VD: 핑계에 지나지 않다 → 핑계일 뿐이다). Tương đương 에 불과하다; văn viết."
  },
  {
  ...
  },
  {
    ...
    notes: "Chỉ năng lực/kỹ năng đã học được. Constraint: CHỈ dùng cho kỹ năng có thể học được (수영, 요리, 운전, 한국어...). Không thể thay '갈 수 있어요?' thành '갈 줄 알아요?'. 줄 알다 vs 줄 몰랐다 (ID 11): 줄 알다 = biết cách; 줄 몰랐다 = không ngờ rằng — hai nghĩa khác nhau hoàn toàn."
  },
  {
    id: 188, grammar: "기 때문에",
    senses: [{ meaning: "vì, do (lý do khách quan)", groupId: "reason_general" }],
    synonymPatterns: ["아/어서", "(으)므로"],
    ownExamples: [{ sentence: "비가 오<b>기 때문에</b> 행사를 취소했어요.", translation: "Vì trời mưa nên đã hủy sự kiện." }],
    notes: "Chỉ nguyên nhân khách quan. Constraint: KHÔNG dùng đuôi câu mệnh lệnh/rủ rê (-(으)세요, -자, -(으)ㅂ시다) ở vế sau — đây là bẫy TOPIK cơ bản. Khi vế sau là mệnh lệnh/rủ rê, BẮT BUỘC dùng (으)니까, KHÔNG thay bằng 기 때문에 hay 아서/어서."
  },
  {
    id: 189, grammar: "아/어서",
    senses: [{ meaning: "vì, nên (nguyên nhân cơ bản)", groupId: "reason_general" }],
    synonymPatterns: ["기 때문에", "(으)므로"],
    ownExamples: [{ sentence: "배가 고파<b>서</b> 밥을 먹었어요.", translation: "Vì đói nên tôi ăn cơm." }],
    notes: "Cơ bản nhất trong nhóm nguyên nhân. Constraint: KHÔNG dùng đuôi câu mệnh lệnh/rủ rê ở vế sau. Constraint: KHÔNG gắn thì quá khứ 았/었 trực tiếp trước 서 (았어서 → SAI). Khi vế sau là mệnh lệnh/rủ rê, BẮT BUỘC dùng (으)니까."
  },
  {
    id: 190, grammar: "(으)므로",
    ...
    notes: "Văn viết trang trọng. Có thể gắn thì quá khứ/tương lai ở trước (았/었으므로, 겠으므로). Constraint: KHÔNG dùng đuôi câu mệnh lệnh/rủ rê ở vế sau (giống 아서/어서 và 기 때문에)."
  },
  {
    id: 191, grammar: "(으)려니와/거니와",
    senses: [{ meaning: "không những... mà còn (thừa nhận rồi bổ sung)", groupId: "addition" }],
    synonymPatterns: ["(으)ㄹ 뿐만 아니라", "(으)ㄴ/는 것은 물론이고", "(으)ㄹ 뿐더러"],
    ownExamples: [
    ...
    notes: "Văn viết, trang trọng hơn 뿐만 아니라. Dùng khi thừa nhận vế trước và bổ sung thêm thông tin vế sau cùng chiều. Constraint: KHÔNG thay thế 1-1 bằng 데다가 trong văn nói thông thường vì 려니와/거니와 thuộc văn phong trang trọng — thay thế sẽ gây lệch văn phong nghiêm trọng trong bài thi TOPIK."
  },
  {
    id: 192, grammar: "(으)ㄹ 것까지 없다",
    senses: [{ meaning: "không cần đến mức phải, không cần thiết phải vậy", groupId: "no_need_exemption" }],
    synonymPatterns: ["(으)ㄹ 필요가 없다", "굳이 (~지 않아도 되다)"],
    ownExamples: [
  ...
  },
  {
    ...
    notes: "두말 = 'hai lời' → không cần đến lần nói thứ hai. Mạnh và trang trọng hơn 말할 것도 없다 (ID 171). Constraint: Là adverbial connector — PHẢI có mệnh đề khẳng định sau, không dùng độc lập được. Khác 말할 것도 없다 (predicate, cuối câu độc lập): 두말할 것도 없이 là connector buộc phải nối mệnh đề sau. Constraint: KHÔNG thay thế 1-1 bằng (으)ㄹ 것도 없이 (ID 116) — (으)ㄹ 것도 없이 gắn sau Động từ cụ thể; 두말할 것도 없이 là trạng từ đứng đầu mệnh đề."
  },
  {
  ...
  },
  {
    id: 196, grammar: "는 대로",
    senses: [{ meaning: "ngay khi, vừa...liền (nghĩa 2)", groupId: "immediate" }],
    synonymPatterns: ["자마자", "기가 무섭게", "면 바로", "기가 바쁘게"],
    examples: [
      { sentence: "집에 <b>도착하는 대로</b> 전화해 주세요.", translation: "Vừa về đến nhà thì hãy gọi điện cho tôi ngay nhé." },
      { sentence: "집에 <b>도착하자마자</b> 전화해 주세요.", translation: "Vừa về đến nhà thì gọi điện ngay nhé." }
    ],
    notes: "는 대로 (Nghĩa 2): 'Ngay khi / vừa xong thì' → đồng nghĩa với 자마자. Thường dùng với các kế hoạch, dự định. Constraint: TUYỆT ĐỐI KHÔNG nhầm lẫn với 는 대로 nghĩa 1 (ID 36 = 'theo như'). Hai nghĩa phải được xử lý độc lập trong database."
  },
  {
    id: 197, grammar: "도록",
    senses: [{ meaning: "để (mục đích/sai khiến)", groupId: "purpose_cause" }],
    ...
    notes: "Ngữ pháp chỉ mục đích hoặc sai khiến (để cho ai đó làm gì). Constraint: KHÔNG nhầm với 도록 nghĩa 'đến tận' (ID 19). Khi mang nghĩa sai khiến (학생들이 조용히 하도록), chủ ngữ 2 vế phải KHÁC NHAU — đây là điểm phân biệt với 기 위해서 (bắt buộc cùng chủ ngữ), do đó KHÔNG thay thế bằng 기 위해서. Constraint: Khi mang nghĩa mục đích đơn thuần (잊지 않도록), có thể thay bằng 게; khi mang nghĩa sai khiến thì 게 và 도록 vẫn tương đương nhưng 기 위해서, 고자 KHÔNG thay thế được."
  },
  {
    id: 198, grammar: "더니",
    senses: [{ meaning: "nguyên nhân (từ quan sát quá khứ)", groupId: "reason_observe" }],
    synonymPatterns: ["아서/어서"],
    examples: [
      { sentence: "매일 운동하<b>더니</b> 건강해졌어요.", translation: "Ngày nào cũng tập thể dục nên giờ đã khỏe ra." }
    ],
    notes: "Chỉ dùng khi người nói đã TRỰC TIẾP quan sát/trải nghiệm ở quá khứ. Constraint: Chủ ngữ quan sát phải là ngôi 3 (quan sát người khác). KHÔNG dùng ngôi thứ nhất (나/저) ở vế 1."
  },
  {
    id: 199, grammar: "더니",
    senses: [{ meaning: "thứ tự (quan sát quá khứ)", groupId: "sequence" }],
    synonymPatterns: ["고 나서"],
    examples: [
      { sentence: "노래를 부르<b>더니</b> 춤도 추기 시작했어요.", translation: "Hát xong rồi bắt đầu nhảy luôn." }
    ],
    notes: "Chỉ dùng khi người nói đã TRỰC TIẾP quan sát/trải nghiệm ở quá khứ. Constraint: Chủ ngữ phải là ngôi 3. KHÔNG dùng ngôi thứ nhất ở vế 1. Constraint: Chỉ thay thế bằng 고 나서 khi ngữ cảnh là quan sát trực tiếp ngôi 3 — 고 나서 không yêu cầu người nói phải trực tiếp quan sát, nên KHÔNG thay thế tự do trong mọi ngữ cảnh."
  },
  {
    id: 200, grammar: "(으)ㄹ 뿐더러",
    senses: [{ meaning: "không những...mà còn", groupId: "addition" }],
    synonymPatterns: ["(으)ㄹ 뿐만 아니라", "(으)려니와/거니와", "(으)ㄴ/는 것은 물론이고", "은/는 말할 것도 없고"],
    examples: [
      { sentence: "그는 성격이 <b>좋을 뿐더러</b> 능력도 뛰어나다.", translation: "Anh ấy không những tính cách tốt mà còn có năng lực xuất sắc." }
    ],
    notes: "Văn viết, trang trọng hơn 뿐만 아니라. Cấu trúc: V/A-(으)ㄹ 뿐더러. Constraint: KHÔNG thay thế 1-1 bằng 데다가 trong văn nói — 뿐더러 thuộc văn phong trang trọng/văn viết, thay thế sẽ gây lệch văn phong."
  },
  {
    ...
    notes: "Nhấn mạnh đây là lựa chọn duy nhất; tương đương (으)ㄹ 수밖에 없다. Constraint: Khi thay bằng 지 않을 수 없다, câu phải mang tính bất khả kháng rõ ràng và cảm xúc mạnh (phủ định kép) — KHÔNG thay thế tự do trong mọi ngữ cảnh vì 지 않을 수 없다 nhấn mạnh sắc thái cảm xúc/bất lực mạnh hơn 아/어야 할 뿐이다."
  },
  {
    id: 203, grammar: "려거든",
    ...
    notes: "Văn nói/trang trọng; mang tính điều kiện + khuyên bảo; tương đương (으)려면. Constraint: Vế sau BẮT BUỘC là mệnh lệnh hoặc lời khuyên (-(으)세요, -아/어야 하다, -는 게 좋다...). Constraint: Động từ đứng trước phải là nguyên thể, cấm chia thì (았/었)."
  },
  {
    id: 204, grammar: "자면",
    senses: [{ meaning: "nếu muốn/định... thì (rút gọn)", groupId: "condition_intent" }],
    synonymPatterns: ["(으)려면", "려거든", "고 싶으면"],
    examples: [
      { sentence: "빨리 도착하<b>자면</b> 지금 출발해야 한다.", translation: "Muốn đến sớm thì phải xuất phát ngay bây giờ." }
    ],
    notes: "Rút gọn của 려면 hoặc 고자 하면; văn viết, trang trọng. Constraint: Vế sau BẮT BUỘC là mệnh lệnh hoặc lời khuyên — giống ràng buộc của (으)려면 và 려거든. Constraint: Động từ đứng trước phải là nguyên thể, cấm chia thì (았/었)."
  },
  {
    ...
    notes: "Thừa nhận vế trước nhưng đưa ra nhận xét/đối lập ở vế sau. Constraint: Khác 지만 (đối lập trực tiếp): 기는 하지만 mang sắc thái thừa nhận có chủ ý trước rồi mới đối lập — không thay thế 1-1 trong mọi ngữ cảnh. Khi thay bằng (으)ㄴ/는가 하면, cần đảm bảo câu đang liệt kê hai khía cạnh của cùng một chủ thể chứ không chỉ đơn thuần thừa nhận rồi phủ nhận."
  }
];